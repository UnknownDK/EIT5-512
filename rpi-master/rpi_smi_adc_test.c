...
#define SMI_TIMING_28M   2,  4,  9,  5 // 27.77 MS/s
...
#define NSAMPLES        500 // Set amount of samples 
#define PRE_SAMP        24 // First samples are weird
...
#define SMI_DREQ_PIN    24 // Synes ikke den her bliver brugt?
#define TEST_PIN        25
